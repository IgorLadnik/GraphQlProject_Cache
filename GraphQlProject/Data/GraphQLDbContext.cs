    ...
    public class GraphQLDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, StrId = "u_01", UserName = "Rachel",  Password = "rrr", Permissions = "11" },
                new User { Id = 2, StrId = "u_02", UserName = "Sandeep", Password = "sss", Permissions = "10" },
                new User { Id = 3, StrId = "u_03", UserName = "Nick",    Password = "nnn", Permissions = "00" }
            );
        }
    }
}
